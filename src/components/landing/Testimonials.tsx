...
const testimonials = [
  {
    ...
    content:
      "They completely transformed our web presence. The new SaaS platform is faster, more beautiful, and highly scalable. An absolute game-changer for our business.",
  },
  {
    name: "Michael Chen",
    ...
    content:
      "The AI automation workflows they built saved our team hundreds of hours every month. Truly a premium agency that understands both design and complex engineering.",
  },
  {
    name: "Jessica Alba",
    ...
    content:
      "Outstanding attention to detail and design. Our users love the new interface, and conversion rates have doubled since the redesign.",
  },
];
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex gap-1 text-yellow-500 mb-8">
                {[...Array(5)].map((_, j) => (
                  <Star
                    key={j}
                    className="h-5 w-5 fill-current drop-shadow-[0_0_5px_rgba(234,179,8,0.5)]"
                  />
                ))}
              </div>
            ...
            <div className="mt-10 flex items-center gap-4 relative z-10">
              <img
                src={t.image}
                alt={t.name}
                className="h-14 w-14 rounded-full border-2 border-border/50 object-cover"
              />
              <div>
