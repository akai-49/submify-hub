  ...
  return (
    ...
    >
      <div className="container mx-auto flex w-full items-center justify-between px-6 lg:px-8">
        <Link
          to="/"
          className="flex items-center gap-2 font-bold text-2xl tracking-tighter text-foreground group"
        >
        ...
        <div className="hidden items-center gap-4 md:flex">
          ...
          <Button
            className="rounded-full px-6 bg-primary hover:bg-primary-hover text-primary-foreground shadow-sm transition-all hover:scale-105 border-0 font-medium"
            asChild
          >
              ...
              <div className="flex flex-col gap-3 mt-6">
                {user ? (
                  ...
                  <>
                    ...
                    <Button
                      className="w-full justify-center h-12 rounded-lg bg-primary hover:bg-primary-hover text-white font-medium"
                      asChild
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      <a href="#contact">Book a Call</a>
